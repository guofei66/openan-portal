...
function openanPluginDiscovery() {
    ...
    function buildModuleCode() {
        ...
        // A plugins/ directory is not required — the framework-only tree has
        // none. Contributed plugins land in their own PRs; until then the
        // discovery simply yields an empty plugin list.
